    ...
    <div class="col-sm-9 col-12">
     ...
     <ul class="list-group p-0">
      <li class="list-group-item bg-success text-white">
        <span class="student"><span uk-icon="icon: info; ratio: 1.2"></span>&nbsp;&nbsp;প্রাক্তন অধ্যক্ষবৃন্দ</span>
      </li>
        ...
        <div class="col-sm-12 col-12 p-0">
          <div class="row">
            ...
            <div class="col-sm-6 col-12 mt-3" data-aos="fade-right" data-aos-duration="2000">
              ...
              <tr>
                <td colspan="3"><center><a href="{{ url('prevprincipledetails',$d->id) }}" class="btn btn-warning text-white btn-sm float-end">বিস্তারিত দেখুন</a></center></td> 
              </tr>               
            </table>
