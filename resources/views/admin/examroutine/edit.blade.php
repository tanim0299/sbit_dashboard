	...
	<div class="col-12">
		...
		<div class="card">
			<div class="card-body">
				...
				<h3>@lang('examroutine.edittitle')</h3><br>


				<form method="post" class="btn-submit" action="{{ route('examroutine.update',$data->id) }}" enctype="multipart/form-data">
					@csrf
					@method('PUT')
					...
					<div class="row myinput">
						...
						<div class="form-group mb-3 col-md-12">
							<label>@lang('examroutine.image'):</label>
							<div class="input-group">
								<input class="form-control" type="file" name="image" id="image">
								<br>
							</div>
							<a href="{{ asset($data->image) }}" download="" class="btn btn-info">@lang('examroutine.download')</a>
						</div>
